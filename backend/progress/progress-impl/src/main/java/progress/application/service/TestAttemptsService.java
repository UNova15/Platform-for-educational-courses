...
import progress.application.exception.TestAlreadyCompletedException;
import progress.application.exception.TestAttemptNotFoundException;
import progress.application.exception.TestNotFoundException;
import refactor.progress.implementation.application.port.in.testprogress.EndTestAttemptCommand;
import refactor.progress.implementation.application.port.in.testprogress.EndTestAttemptUseCase;
import refactor.progress.implementation.application.port.in.testprogress.StartTestAttemptUseCase;
import refactor.progress.implementation.application.port.out.external.TestAnswerKeyProviderPort;
...
import refactor.progress.implementation.application.port.out.persistance.testattempt.TestAttemptLoadPort;
import refactor.progress.implementation.application.port.out.persistance.testattempt.TestAttemptSavePort;
