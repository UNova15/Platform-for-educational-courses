...
import static kira.auth.domain.user.valueobject.Login.MAX_LOGIN_LENGTH;
import static kira.auth.domain.user.valueobject.Login.MIN_LOGIN_LENGTH;
import static kira.auth.domain.user.valueobject.RawPassword.MAX_PASSWORD_LENGTH;
import static kira.auth.domain.user.valueobject.RawPassword.MIN_PASSWORD_LENGTH;
