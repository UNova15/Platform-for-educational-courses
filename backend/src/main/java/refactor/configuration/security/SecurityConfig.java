...
public class SecurityConfig {
    ...
    @Bean
    public UserDetailsService userDetailsService(UserLoadPort userLoadPort) {
        return login -> SecurityUser.fromUser(
                userLoadPort.loadUserByLogin(login).orElseThrow(() -> new UsernameNotFoundException(login)));
    }
}
