...
import refactor.progress.application.exception.LessonAlreadyCompletedException;
...
import refactor.progress.application.port.out.persistance.LessonProgressSavePort;
import refactor.progress.application.port.out.persistance.EnrollmentLoadPort;
import refactor.progress.application.port.out.persistance.LessonProgressLoadPort;
