...
public class StudentCourseController {
    ...
    @GetMapping
    public ResponseEntity<List<CourseEnrolledFindResponse>> getCourses(@AuthenticationPrincipal SecurityUser securityUser) {
    ...
    public ResponseEntity<StudentCourseFindResponse> getCourse(@PathVariable long courseId,
    ...
    public ResponseEntity<TestReview> getTestReview(@PathVariable long courseId,
                                                    @PathVariable long moduleId,
    ...
    @PreAuthorize("@courseSecurity.canAccessTest(#securityUser.id,#courseId,#moduleId,#testId)")
    public ResponseEntity<TestFindResponse> startTestAttempt(@PathVariable long courseId,
                                                             @PathVariable long moduleId,
                                                             @PathVariable long testId,
                                                             @AuthenticationPrincipal SecurityUser securityUser) {
    ...
    @PreAuthorize("@courseSecurity.canAccessTest(#securityUser.id,#courseId,#moduleId,#testId)")
    public ResponseEntity<Void> postTest(@PathVariable long testId,
