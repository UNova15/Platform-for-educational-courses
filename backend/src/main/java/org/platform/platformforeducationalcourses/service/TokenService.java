...
public class TokenService {
    ...
    public TokenDto createTokens(long userId, String login, UserRole role) {
        ...
        refreshTokenRepository.save(RefreshTokenEntity.withToken(refreshToken));
    ...
    public TokenDto recreateTokens(String oldRawRefreshToken) {
        ...
        RefreshTokenEntity tokenFromDb = refreshTokenRepository
        ...
        refreshTokenRepository.save(RefreshTokenEntity.withToken(newRefreshToken));
