...
public class ModuleService {
    ...
    public void updateModule(ModuleUpdateDto updateDto) {
        CourseModule module = moduleRepository.findById(updateDto.moduleId())
                .orElseThrow();
    ...
    public ModuleCreateResponse createModule(ModuleCreateDto moduleDto) {
        CourseModule module = CourseModule.createNew(moduleDto.courseId(), moduleDto.title(),
                moduleDto.description(), moduleDto.orderIndex());
