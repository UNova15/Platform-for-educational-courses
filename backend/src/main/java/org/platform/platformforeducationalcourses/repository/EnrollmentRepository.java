...
public interface EnrollmentRepository extends CrudRepository<Enrollment, Long> {
    ...
    @Query("""
            ...
            """)
    Optional<Enrollment> findEnrollmentForLessonIfUserIsStudying(@Param("userId") long userId,
    ...
    @Query("""
            ...
            WHERE e.user_id = :userId AND e.course_id = :courseId
            """)
    Optional<Enrollment> findEnrollmentForTestIfUserIsStudying(@Param("userId") long userId,
                                                               @Param("courseId") long courseId,
                                                               @Param("moduleId") long moduleId,
