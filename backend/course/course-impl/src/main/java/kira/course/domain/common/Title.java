package kira.course.domain.common;
...
// Используется общий Value object(Vo) для title т.к. инвариант для всех доменных классов использующих данный Vo
...
// boilerplate кода используется единый Vo.
@Getter
