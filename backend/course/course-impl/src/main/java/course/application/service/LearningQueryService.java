...
import refactor.course.implementation.application.port.out.external.EnrollmentCheckPort;
import refactor.course.implementation.application.port.out.external.TestCompletionCheckPort;
import refactor.course.implementation.application.port.out.external.UserEnrollmentProviderPort;
import refactor.course.implementation.application.port.out.persistance.query.LearningQueryPort;
