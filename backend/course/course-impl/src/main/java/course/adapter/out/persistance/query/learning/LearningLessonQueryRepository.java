package course.adapter.out.persistance.query.learning;

import org.springframework.data.jdbc.repository.query.Query;
import org.springframework.data.repository.CrudRepository;
import org.springframework.data.repository.query.Param;
import course.adapter.out.persistance.lesson.LessonEntity;
import course.application.port.in.query.learning.StudentsLessonView;
import course.application.port.in.query.learning.StudentsModuleView;
...
public interface LearningLessonQueryRepository extends CrudRepository<LessonEntity, Long> {
    ...
    @Query("SELECT id,title,module_id,order_index,mandatory FROM lessons l WHERE l.module_id = :moduleId")
