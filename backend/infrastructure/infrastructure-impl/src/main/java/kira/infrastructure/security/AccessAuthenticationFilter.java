package kira.infrastructure.security;
...
import kira.infrastructure.accesstoken.AccessTokenDecoder;
...
class AccessAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            var authentication = new UsernamePasswordAuthenticationToken(payload, accessToken, authorities);
